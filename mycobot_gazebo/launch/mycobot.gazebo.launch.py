...
def generate_launch_description():
    ...
    ld.add_action(robot_state_publisher_cmd) # robot_state_publisher: subscribe /joint_states and publish /tf, /robot_description(urdf file)    
    ld.add_action(start_gazebo_cmd) # start gazebo: load world.
    ld.add_action(start_gazebo_ros_bridge_cmd)
    ld.add_action(start_gazebo_ros_image_bridge_cmd)
    ld.add_action(start_gazebo_ros_spawner_cmd) # subscribe /robot_description(urdf file) and spawn the robot, configure ros2_control::hardware_interface, load ros2_control::controller_manager
    ld.add_action(load_controllers_cmd) # load ros2_controller
