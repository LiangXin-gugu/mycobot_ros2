...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'gugu_workspace/mycobot_ros2/src/mycobot_moveit_config/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'gugu_workspace/mycobot_ros2/install/mycobot_moveit_config/share/mycobot_moveit_config/config',
        robot_name
    )
